 ...
 * For example <code>
 * <p>
 * http://../jmx?get=Hadoop:service=*,name=PHOENIX-REST::createTableSuccess
 * </p>
 * </code>
 * </p>
        ...
        try {
            ...
            try {
                ...
                if (getmethod != null) {
                    ...
                    if (beanWriter.write(this.mBeanServer, new ObjectName(i.next()), i.next(),
                            description) != 0) {
                        beanWriter.flush();
                        response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
                    }
                ...
                if (beanWriter.write(this.mBeanServer, new ObjectName(qry), null, description)
                        != 0) {
                    beanWriter.flush();
                    response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
                }
